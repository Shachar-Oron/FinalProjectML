...
You can see that the sum of the values in the confution matrix is not the size of the test_data because apparently the algorithm ignored repeating values or abnormal values.
### Improving SVM Model.
